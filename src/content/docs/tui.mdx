---
title: TUI
description: Using the Ishi terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Ishi provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Ishi starts the TUI for the current directory.
...
When using the Ishi TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Ishi. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Ishi config file.
