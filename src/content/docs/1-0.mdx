...
Ishi 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same ishi server.
...
version. However some older versions of Ishi always grab latest.
