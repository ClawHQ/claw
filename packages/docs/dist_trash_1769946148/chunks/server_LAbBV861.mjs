...
const frontmatter = {
  "title": "Server",
  "description": "Interact with ishi server over HTTP."
};
...
const file = "/Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/src/content/docs/server.mdx";
...
Content.moduleId = "/Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/src/content/docs/server.mdx";
