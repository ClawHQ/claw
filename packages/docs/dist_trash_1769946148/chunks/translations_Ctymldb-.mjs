import { g as getCollection } from './_astro_content_B-blkXYm.mjs';
import { o as objectType, s as stringType } from './types_DZQNl0rU.mjs';
import { a as AstroUserError } from './astro/server_vJilpAfn.mjs';

const starlightConfig = {"logo":{"dark":"./src/assets/logo-dark.svg","light":"./src/assets/logo-light.svg","alt":"","replacesTitle":true},"social":[{"icon":"github","label":"GitHub","href":"https://github.com/ClawHQ/claw-desktop"},{"icon":"discord","label":"Discord","href":"https://discord.gg/claw"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Claw Desktop","translations":{},"collapsed":false,"items":[{"label":"Introduction","translations":{},"link":"/","attrs":{}}]},{"label":"Getting Started","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"connection","attrs":{}},{"translations":{},"slug":"runs","attrs":{}},{"translations":{},"slug":"approvals","attrs":{}}]},{"label":"Features","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"sync","attrs":{}},{"translations":{},"slug":"artifacts","attrs":{}},{"translations":{},"slug":"offline","attrs":{}}]},{"label":"Integration","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"openclaw-setup","attrs":{}},{"translations":{},"slug":"slack-integration","attrs":{}},{"translations":{},"slug":"deployment","attrs":{}}]},{"label":"OpenClaw Engine","translations":{},"collapsed":false,"autogenerate":{"directory":"engine"}},{"translations":{},"slug":"troubleshooting","attrs":{}}],"head":[],"lastUpdated":true,"pagination":false,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Claw"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/","srcDir":"file:///Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/src/","trailingSlash":"always"};
...
export { BuiltInDefaultLocale as B, starlightConfig as a, stripTrailingSlash as b, stripLeadingSlash as c, stripHtmlExtension as d, ensureHtmlExtension as e, ensureTrailingSlash as f, getCollectionPathFromRoot as g, pickLang as h, ensureLeadingSlash as i, stripExtension as j, getCollectionPath as k, project as p, stripLeadingAndTrailingSlashes as s, useTranslations as u };
