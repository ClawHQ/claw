import { d as createAstro, c as createComponent, r as renderComponent, b as renderTemplate, e as renderSlot } from './astro/server_vJilpAfn.mjs';
import { Base64 } from 'js-base64';
import { c as config } from './config_CxZMLiNA.mjs';
import { H as HeadConfigSchema, u as urlToSlug, s as slugToLocaleData, g as getSidebarFromConfig, a as getSidebar, b as getSiteTitle, c as getToC, d as getSiteTitleHref, e as getPrevNextLinks, f as getHead, h as attachRouteDataAndRunMiddleware, $ as $$Page } from './middleware_ChTolDA6.mjs';
import { s as stripLeadingAndTrailingSlashes, g as getCollectionPathFromRoot, p as project, a as starlightConfig } from './translations_Ctymldb-.mjs';
import { I as Icons, a as I18nBadgeConfigSchema, B as BadgeConfigSchema, p as parseAsyncWithFriendlyErrors, b as parseWithFriendlyErrors } from './Code_fK6YVkYD.mjs';
...
async function getUserDocsSchema() {
  const userCollections = (await import('./collection-config_BssdjMoe.mjs')).collections;
...
}, "/Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/node_modules/.pnpm/@astrojs+starlight@0.34.3_astro@5.7.13_@types+node@22.19.7_rollup@4.57.1_typescript@5.9.3_/node_modules/@astrojs/starlight/components/StarlightPage.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const ogImage = `${config.socialCard}/ishi-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${id}`;
    ...
    head: [
      {
        ...
        attrs: {
          name: "description",
          content: "Ishi - The AI coding agent built for the terminal."
        }
      },
      {
        tag: "meta",
  ...
  } }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Share", null, { "id": id, "api": apiUrl, "info": data.info, "messages": data.messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "/Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/src/components/Share.tsx", "client:component-export": "default" })} ` })} `;
}, "/Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/src/pages/s/[id].astro", void 0);
const $$file = "/Users/sean/WIP/Antigravity-Workspace/claw/packages/docs/src/pages/s/[id].astro";
const $$url = "/docs/s/[id]/";
