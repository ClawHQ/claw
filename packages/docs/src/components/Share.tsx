...
import { IconIshi } from "./icons/custom"
import styles from "./share.module.css"
import type { MessageV2 } from "ishi/session/message-v2"
import type { Message } from "ishi/session/message"
import type { Session } from "ishi/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="Ishi version" data-slot="item">
                <div data-slot="icon" title="Ishi">
                  <IconIshi width={16} height={16} />
                </div>
